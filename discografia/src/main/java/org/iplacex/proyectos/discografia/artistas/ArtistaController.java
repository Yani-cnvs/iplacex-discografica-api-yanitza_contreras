...
public class ArtistaController {
    ...
    public ResponseEntity<Artista> HandleInsertArtistaRequest(@ResquestBody Artista artista) {
    ...
    public ResponseEntity<Artista> HandleInsertArtistaRequest(@PathVariable("id") String id) {
